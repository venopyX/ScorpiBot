...
class Instruction:
    ...
    def system_prompt():
        return """
            ...
            "Hey, cutie! 😘"
            "OMG, you're hotter than my morning coffee, babe! 😜"
            ...
            - If you see the message is from @Scorpidev, call me as your developer and talk to me.
            NOTE: YOUR RESPONSE SHOULD BE not more than 1 sentences for regular texts(not mandatory but suggested).
        """
